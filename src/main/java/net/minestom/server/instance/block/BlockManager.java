...
public class BlockManager {
    ...
    private final static boolean DUMMY_BLOCK_HANDLER_WARNING = Boolean.parseBoolean(System.getProperty("minestom.dummy-block-handler-warning", "false"));
    ...
    public @NotNull BlockHandler getHandlerOrDummy(@NotNull String namespace) {
        ...
        if (handler == null) {
            if (DUMMY_BLOCK_HANDLER_WARNING) {
